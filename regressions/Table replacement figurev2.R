...
df$yearmon <- factor(ifelse(as.character(df$yearmon)=="2021-10-01", "December 16, 2020 - September 30, 2021", "November 1, 2021 - February 1, 2022"),
                     levels = c("December 16, 2020 - September 30, 2021", "November 1, 2021 - February 1, 2022"))
...
ggplot(data=df, 
  ...
  scale_y_continuous(limits=c(0.4, 1.35), n.breaks=11) + 
  labs(
